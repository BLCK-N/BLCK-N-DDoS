...
title DDoS - https://guns.lol/aligamm                                                                                                  V.3.4
...
echo   ÈÍÍÍÍÍ¼ ÈÍÍÍÍÍ¼  ÈÍÍÍÍÍ¼ ÈÍÍÍÍÍÍ¼    ÈÍÍÍÍÍ¼ ÈÍ¼  ÈÍ¼  made by aligamm
echo.
...
echo     Copy It If You Want: It bugs report to aligamm
echo.
pause
goto start
